...
window.DragonZone=window.DragonZone||{};
window.MermaidSlot=window.MermaidSlot||{};
...
window.Slot=window.Slot||{};
	...
	return TopToolSkin;
})(eui.Skin);generateEUI.paths['resource/haydn_skins/dragonZone/MainSkin.exml'] = window.DragonZone.MainSkin = (function (_super) {
	__extends(MainSkin, _super);
	function MainSkin() {
		_super.call(this);
		this.skinParts = ["BG","m_GpMainLayer0","FG","LineTag","m_GpMainLayer1","m_GpMainLayer2","Icon1","m_GpMain","BG0","m_GpFreeLayer0","FG0","m_GpFreeLayer1","m_GpFreeLayer2","m_GpFree","m_GpEffect"];
		
		this.height = 900;
		this.width = 1600;
		this.elementsContent = [this.m_GpMain_i(),this.m_GpFree_i(),this.m_GpEffect_i()];
	}
	var _proto = MainSkin.prototype;

	_proto.m_GpMain_i = function () {
		var t = new eui.Group();
		this.m_GpMain = t;
		t.height = 1196;
		t.horizontalCenter = 0;
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.BG_i(),this._Image1_i(),this.m_GpMainLayer0_i(),this.FG_i(),this.LineTag_i(),this.m_GpMainLayer1_i(),this.m_GpMainLayer2_i(),this.Icon1_i()];
		return t;
	};
	...
	_proto._Image1_i = function () {
		...
		t.source = "dz_ng_bg_02_png";
		t.verticalCenter = 43;
		t.visible = true;
		return t;
	};
	_proto.m_GpMainLayer0_i = function () {
		var t = new eui.Group();
		this.m_GpMainLayer0 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 1196;
		t.scaleX = 1;
	...
	_proto.FG_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "dz_ng_bg_03_png";
		t.verticalCenter = 0;
		t.visible = true;
		return t;
	};
	_proto.LineTag_i = function () {
		var t = new eui.Image();
		this.LineTag = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		...
		t.scaleX = 0.99;
		t.scaleY = 0.99;
		t.source = "dz_ng_bg_linelight_png";
		t.verticalCenter = 0;
		t.visible = true;
		return t;
	};
	_proto.m_GpMainLayer1_i = function () {
		var t = new eui.Group();
		this.m_GpMainLayer1 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 1196;
		t.scaleX = 1;
	...
	_proto.m_GpMainLayer2_i = function () {
		var t = new eui.Group();
		this.m_GpMainLayer2 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 1196;
		t.scaleX = 1;
	...
	_proto.m_GpFree_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.BG0_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Image5_i(),this._Image6_i(),this.m_GpFreeLayer0_i(),this.FG0_i(),this.m_GpFreeLayer1_i(),this.m_GpFreeLayer2_i()];
		return t;
	};
	...
	_proto.m_GpFreeLayer0_i = function () {
		var t = new eui.Group();
		this.m_GpFreeLayer0 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 1196;
		t.scaleX = 1;
	...
	_proto.FG0_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "dz_fg_bg_03_png";
		t.verticalCenter = 0;
		t.visible = true;
		t.width = 1760;
		return t;
	};
	_proto.m_GpFreeLayer1_i = function () {
		var t = new eui.Group();
		this.m_GpFreeLayer1 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 1196;
		t.scaleX = 1;
	...
	_proto.m_GpFreeLayer2_i = function () {
		var t = new eui.Group();
		this.m_GpFreeLayer2 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 1196;
		t.scaleX = 1;
	...
	return MainSkin;
})(eui.Skin);generateEUI.paths['resource/haydn_skins/dragonZone/ReelSkin.exml'] = window.DragonZone.ReelSkin = (function (_super) {
	__extends(ReelSkin, _super);
	function ReelSkin() {
		_super.call(this);
		this.skinParts = ["m_Mask","m_Group"];
		
		this.elementsContent = [this.m_Mask_i(),this.m_Group_i()];
	}
	...
	return ReelSkin;
})(eui.Skin);generateEUI.paths['resource/haydn_skins/dragonZone/SymbolSkin.exml'] = window.DragonZone.SymbolSkin = (function (_super) {
	...
	return LobbySkin;
})(eui.Skin);generateEUI.paths['resource/haydn_skins/mermaidSlot/MainSkin.exml'] = window.MermaidSlot.MainSkin = (function (_super) {
	__extends(MainSkin, _super);
	function MainSkin() {
		_super.call(this);
		this.skinParts = ["m_GpMainLayer0","FG","m_GpMainLayer1","m_GpMainLayer2","m_GpMain","m_GpFreeLayer0","FG0","m_GpFreeLayer1","m_GpFreeLayer2","m_GpFree","m_GpEffect"];
		
		this.height = 900;
		this.width = 1600;
		this.elementsContent = [this._Rect1_i(),this.m_GpMain_i(),this.m_GpFree_i(),this.m_GpEffect_i()];
	}
	var _proto = MainSkin.prototype;
	...
	_proto.m_GpMain_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this.m_GpMainLayer0_i(),this.FG_i(),this.m_GpMainLayer1_i(),this.m_GpMainLayer2_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.FG_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "md_ng_bg_frame_01_png";
		t.verticalCenter = 0;
		t.visible = true;
		return t;
	};
	...
	_proto.m_GpFree_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image2_i(),this.m_GpFreeLayer0_i(),this.FG0_i(),this.m_GpFreeLayer1_i(),this.m_GpFreeLayer2_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	return MainSkin;
})(eui.Skin);generateEUI.paths['resource/haydn_skins/mermaidSlot/ReelSkin.exml'] = window.MermaidSlot.ReelSkin = (function (_super) {
	__extends(ReelSkin, _super);
	function ReelSkin() {
		_super.call(this);
		this.skinParts = ["m_Mask","m_Group"];
	...
	return ReelSkin;
})(eui.Skin);generateEUI.paths['resource/haydn_skins/mermaidSlot/SymbolSkin.exml'] = window.MermaidSlot.SymbolSkin = (function (_super) {
	__extends(SymbolSkin, _super);
	function SymbolSkin() {
		_super.call(this);
		this.skinParts = ["m_Blur","m_Normal","m_Dark","m_Group"];
	...
	_proto.m_Group_i = function () {
		...
		t.visible = true;
		t.width = 310;
		t.elementsContent = [this.m_Blur_i(),this.m_Normal_i(),this.m_Dark_i()];
		return t;
	};
	_proto.m_Blur_i = function () {
		var t = new eui.Image();
	...
	_proto.m_Normal_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "md_icon_01_png";
		t.touchEnabled = false;
		t.verticalCenter = 0;
		t.visible = true;
		return t;
	};
	_proto.m_Dark_i = function () {
		var t = new eui.Image();
		this.m_Dark = t;
		t.anchorOffsetX = 155;
		t.anchorOffsetY = 110;
	...
	function MainSkin() {
		_super.call(this);
		this.skinParts = ["BG","m_GpMainLayer0","FG","m_GpMainLayer1","m_GpMainLayer2","m_GpMain","BG0","m_GpFreeLayer0","FG0","m_GpFreeLayer1","m_GpFreeLayer2","m_GpFree","m_GpEffect"];
	...
	_proto.m_GpMain_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.BG_i(),this._Image1_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Image5_i(),this.m_GpMainLayer0_i(),this.FG_i(),this.m_GpMainLayer1_i(),this.m_GpMainLayer2_i()];
		return t;
	};
	_proto.BG_i = function () {
		var t = new eui.Image();
	...
	_proto.m_GpFree_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.BG0_i(),this._Image6_i(),this._Image7_i(),this._Image8_i(),this._Image9_i(),this._Image10_i(),this.m_GpFreeLayer0_i(),this.FG0_i(),this.m_GpFreeLayer1_i(),this.m_GpFreeLayer2_i()];
		return t;
	};
	_proto.BG0_i = function () {
		var t = new eui.Image();
