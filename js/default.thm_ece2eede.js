...
window.Slot=window.Slot||{};
	...
	var ScoreBarSkin$Skin10 = 	(function (_super) {
		...
		function ScoreBarSkin$Skin10() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","btn_maxbet_black_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var ScoreBarSkin$Skin12 = 	(function (_super) {
		__extends(ScoreBarSkin$Skin12, _super);
		function ScoreBarSkin$Skin12() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = ScoreBarSkin$Skin12.prototype;
		...
		return ScoreBarSkin$Skin12;
	})(eui.Skin);

	function ScoreBarSkin() {
		_super.call(this);
		this.skinParts = ["m_BtnSpin","m_BtnStop","center","bg","m_LogoName","bgCredit","m_GroupCredit","bgWin","m_GroupWin","bgBet","m_GroupBet","m_BtnMaxBet","m_BtnTurboOn","m_BtnTurboOff","bgLastWin","m_GroupLastWin","m_Bottom"];
	...
	_proto.m_Bottom_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.bg_i(),this.m_LogoName_i(),this.bgCredit_i(),this.m_GroupCredit_i(),this.bgWin_i(),this.m_GroupWin_i(),this.bgBet_i(),this.m_GroupBet_i(),this.m_BtnMaxBet_i(),this.m_BtnTurboOn_i(),this.m_BtnTurboOff_i(),this.bgLastWin_i(),this.m_GroupLastWin_i()];
		return t;
	};
	_proto.bg_i = function () {
		var t = new eui.Image();
	...
	_proto.bgCredit_i = function () {
		var t = new eui.Image();
		this.bgCredit = t;
		t.bottom = 95;
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "msg_title_balance_png";
		t.touchEnabled = false;
		t.x = 200;
		return t;
	};
	...
	_proto.bgWin_i = function () {
		var t = new eui.Image();
		this.bgWin = t;
		t.bottom = 95;
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "msg_title_win_png";
		t.touchEnabled = false;
		t.x = 650;
		return t;
	};
	...
	_proto.bgBet_i = function () {
		var t = new eui.Image();
		this.bgBet = t;
		t.bottom = 95;
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "msg_title_bet_png";
		t.touchEnabled = false;
		t.x = 1072;
		return t;
	};
	...
	_proto.m_BtnTurboOff_i = function () {
		...
		t.x = 1515;
		t.y = 797;
		t.skinName = ScoreBarSkin$Skin12;
		return t;
	};
